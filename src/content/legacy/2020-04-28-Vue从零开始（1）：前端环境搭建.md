...
date: 2020-04-28
description: "前言 Vue https://cn.vuejs.org/ 是一套用于构建用户界面的渐进式框架。与其它大型框架不同的是，Vue被设计为可以自底向上逐层应用。Vue的核心库只关注视图层，不仅易于上手，还便于与第三方库或既有项目整合。另一方面，当"
categories:
  - Vue从零开始
tags:
  - Vue
legacyPath: "/vue从零开始/Vue从零开始-1-前端环境搭建/"
lastModified: "2020-04-28 15:11:25"
---
