...
date: 2021-04-24
description: "前言 Vue3 跟 Vite 正式版发布有很长一段时间了，可我到现在Vue2都还没整明白，学不动了呀，Angular和React也都快忘完了。但该学还是要学，今天再开个专栏，记录下学习Vue3的过程。 言归正传，这篇主要讲怎么搭建一套规范的"
categories:
  - Vue
tags:
  - Vue3
legacyPath: "/vue/Vue3前传-创建工程时必须要做的事/"
lastModified: "2021-04-24 14:51:17"
---
...
这里只做一些简单的配置，如端口、路径、代理等。详细配置可以看Vite的官网：[https://cn.vitejs.dev/config/](https://cn.vitejs.dev/config/)
