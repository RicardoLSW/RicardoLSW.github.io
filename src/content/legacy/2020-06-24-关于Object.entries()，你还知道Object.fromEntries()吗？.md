...
date: 2020-06-24
description: "前言 我们知道要把一个 Object 转换成 Array ，可以使用 Object.entries 。但是如果你想把一个 Array 转换成 Object 怎么办？我们可以使用 Object.fromEntries ，它来自ES10语法。 "
categories:
  - 前端
tags:
  - JavaScript
legacyPath: "/前端/关于Object.entries()-你还知道Object.fromEntries()吗/"
lastModified: "2020-06-24 16:49:58"
---
