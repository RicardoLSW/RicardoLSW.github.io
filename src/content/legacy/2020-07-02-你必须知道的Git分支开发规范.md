...
date: 2020-07-02
description: "分支管理 分支命名 master 分支 master 分支为主分支，用于部署生产环境，需要确保master分支的稳定性。 此分支属于只读分支，只能从 release 分支合并过来，任何时候都不能在此分支修改代码。 所有向master分支的推"
categories:
  - 工具
tags:
  - git
legacyPath: "/工具/你必须知道的Git分支开发规范/"
lastModified: "2020-07-02 10:43:31"
---
