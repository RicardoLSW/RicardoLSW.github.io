...
date: 2020-06-19
description: "前言 上一篇讲到了如何通过路由创建页面以及Mock的使用，然而在实际项目中，大部分中后台前端项目对于菜单都有一个权限控制，像某某角色只能看到这些菜单页面，某某角色只能看到另一些菜单页面，还有一些角色他们能看到同一个页面，但是其中一个只能查看"
categories:
  - Vue从零开始
tags:
  - Vue
legacyPath: "/vue从零开始/Vue从零开始-4-动态路由菜单+权限控制/"
lastModified: "2020-06-19 13:37:28"
---
