...
date: 2020-04-16
description: "前言 学习iOS开发一个多月了，最近做项目的时候碰到一个这样的需求：一个展示数据的面板，里面有一个表格，表格的数据循环滚动。类似下图： 我这个人又比较懒，一开始直接上Google看看有没有现成的控件使用，翻了半天也没找到一些能用的东西，基本"
categories:
  - 移动端
tags:
  - Objective-C
legacyPath: "/移动端/iOS端UI控件-循环滚动表格/"
lastModified: "2020-04-16 15:50:03"
---
...
![](https://figure-b.ricardolsw.com/image/lefSeuyZ3CBG6nOSNugewblfbKIzJjpK.gif?x-oss-process=style/watermark)
...
1. 效果图：
   ...
   ![](https://figure-b.ricardolsw.com/image/lefSeuyZ3CBG6nOSNusvYblfbKIzJjpK.gif?x-oss-process=style/watermark)
