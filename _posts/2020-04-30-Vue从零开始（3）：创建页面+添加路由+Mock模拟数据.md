...
![](https://figure-b.ricardolsw.com/image/jWbQ5x1OZQhcRIfdt0H8csMDbRJ3ii9k.jpg)
...
![](https://figure-b.ricardolsw.com/image/koGYXZZPRsJ3wtlV2Pjee4vQJPoV0cTl.jpg)
...
![](https://figure-b.ricardolsw.com/image/gaYYAcLkcYdaiepZ4rINkfLa7q0K4hD9.jpg)

### 写在最后

到这里，从创建页面到添加路由再到模拟数据获取数据这一整个的流程我们就走完了，当然上面那个页面并没有做完，还剩一些功能没有开发：条件搜索、新增、编辑和删除，还有表单提交这个功能，这些留到后面再讲吧~哈哈哈

![](https://figure-b.ricardolsw.com/image/vzhzAh9V8WshxRCjSxaLP9CgS0hfES90.jpg)
